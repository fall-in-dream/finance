...
public class MailUtil {
    ...
    // 发件人的邮箱-修改为自己的
    public static String emailAccount = "879407781@qq.com";
    // 发件人邮箱授权码-修改为自己的
    public static String emailPassword = "fsgfsjwtzsbxbfhi";
    // 发件人邮箱服务地址-修改为自己的
    public static String emailSMTPHost = "smtp.qq.com";
    //  收件人邮箱
    public static String receiveMailAccount = "879407781@qq.com";
