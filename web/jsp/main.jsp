...
<head>
    ...
    <!-- 自定义控件 -->
    <script type="text/javascript"
            src="${pageContext.request.contextPath }/jedate/jquery.jedate.js" charset="utf-8"></script>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/app/js/offcanvas.js" charset="utf-8"></script>
                                ...
                                <div class="mytable">
                                    <form action="" method="post">
                                        <table class="table">
                                            ...
                                            <!-- 表格中的数据 -->
                                            <tbody id="tableData">
                                            <c:forEach items="${ requestScope.IncomeExpensePage.list}" var="IncomeExpenseRecord">
                                                <tr class="active">
                                                    <td class="hidden-xs"><input type="checkbox"
                                                                                 id="${IncomeExpenseRecord.ie_id }" name="record"></td>
                                                    <td class="hidden-xs">${IncomeExpenseRecord.ie_id }</td>
